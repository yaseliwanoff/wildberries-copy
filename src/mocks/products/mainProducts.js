const productsMock = [
  {
    ...
    "media": {
      ...
      "video": null,
      "colorSwatches": [
        { "colorName": "черный", "imageUrl": "https://images.unsplash.com/photo-1551489186-cf8726f514f8?w=200" },
        { "colorName": "бежевый", "imageUrl": "https://images.unsplash.com/photo-1565084888275-a1fc670e2e1b?w=200" },
        { "colorName": "изумрудный", "imageUrl": "https://images.unsplash.com/photo-1576566588028-4147f3842f27?w=200" }
      ]
    },
    "options": {
      "sizes": [
    ...
    "details": {
      "description": "Стильное платье миди свободного кроя. Пояс в комплекте. Отложной воротник и планка на пуговицах создают элегантный рубашечный фасон. Идеально подходит как для офиса, так и для повседневных выходов.",
  ...
  },
  {
    ...
    "media": {
      ...
      "colorSwatches": [
        { "colorName": "черный", "imageUrl": "https://images.unsplash.com/photo-1618366712010-f4ae9c647dcb?w=200" },
        { "colorName": "белый", "imageUrl": "https://images.unsplash.com/photo-1609081219090-a6d81d3085bf?w=200" }
      ]
    },
    "options": {
      "sizes": [],
    ...
    "details": {
      "description": "Флагманская модель TWS-наушников с гибридным активным шумоподавлением до 42 дБ. Сенсорное управление, прозрачный режим и поддержка кодека LDAC.",
  ...
  },
  {
    ...
    "details": {
      "description": "Многослойный матрас с эффектом памяти. Независимый пружинный блок Pocket Spring (1000 пружин на кв.м.). Чехол из жаккарда с простежкой на холконе.",
